 ...
 *
 * @param {Array<T>} array - a sorted array to search.
 * @param {U} searchKey - the item to search for.
 * @param {function(T): U} [compareKey] - `compareKey` is called on elements of the array once
